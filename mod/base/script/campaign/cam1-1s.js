...
function checkForPowerModule()
{
	if (cheat || powerModuleBuilt())
	{
		...
		setMissionTime(camChangeOnDiff(camMinutesToSeconds(120))); // 120 min for offworld
		secondVideo();
...
function eventStartLevel()
{
	...
	setMissionTime(camChangeOnDiff(camMinutesToSeconds(40))); // 40 min for building module.
