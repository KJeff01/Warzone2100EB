...
function checkForPowerModule()
{
	if (cheat || powerModuleBuilt())
	{
		...
		setMissionTime(camChangeOnDiff(camMinutesToSeconds(60))); // 60 min for offworld
		secondVideo();
...
function eventStartLevel()
{
	...
	setMissionTime(camChangeOnDiff(camMinutesToSeconds(20))); // 20 min for building module.
